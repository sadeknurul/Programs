...
struct student
{
 ...
 string Registration;//for Registration number
...
if(studentData.fname==find)
{
 ...
 cout<<"Department: "<<studentData.classes<<endl<<endl;
}
...
for(i=0;choice!='n'&& choice!='N';i++)
{
 ...
 if((choice=='y')||(choice=='Y')||(choice=='1'))
 {
  ...
  cin>>tech[i].exp;
  cout<<"Enter number of year in ISTT: ";
  cin>>tech[i].serves;
...
for( j=0;((j<i)||(!t2.eof()));j++)
{
 ...
 if(tech[j].fst_name==find)
 {
  ...
  cout<<"Number of year in ISTT: "<<tech[j].serves<<endl;
